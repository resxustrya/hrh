...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets_ace/css/jquery.gritter.min.css') }}assets/css/" />
                            ...
                            <div class="tab-content no-border padding-24">
                                <div id="home" class="tab-pane in active">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{ asset('public/assets_ace/images/avatars/profile-pic.jpg') }}" />
															</span>
                                ...
                                <div id="pictures" class="tab-pane">
                                    <ul class="ace-thumbnails">
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <img alt="150x150" src="{{ asset('public/assets_ace/images/gallery/thumb-2.jpg') }}" />
                                                <div class="text">
                                                    <div class="inner">Sample Caption on Hover</div>
                                                </div>
                                            </a>
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <img alt="150x150" src="{{ asset('public/assets_ace/images/gallery/thumb-3.jpg') }}" />
                                                <div class="text">
                                                    <div class="inner">Sample Caption on Hover</div>
                                                </div>
                                            </a>
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <img alt="150x150" src="{{ asset('public/assets_ace/images/gallery/thumb-4.jpg') }}" />
                                                <div class="text">
                                                    <div class="inner">Sample Caption on Hover</div>
                                                </div>
                                            </a>
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <img alt="150x150" src="{{ asset('public/assets_ace/images/gallery/thumb-5.jpg') }}" />
                                                <div class="text">
                                                    <div class="inner">Sample Caption on Hover</div>
                                                </div>
                                            </a>
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <img alt="150x150" src="{{ asset('public/assets_ace/images/gallery/thumb-6.jpg') }}" />
                                                <div class="text">
                                                    <div class="inner">Sample Caption on Hover</div>
                                                </div>
                                            </a>
